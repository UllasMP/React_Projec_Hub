            ...
            <div className="container px-5 py-8 md:py-16 mx-auto">
                ...
                <div className="flex flex-wrap -m-4">
                    {product
                        ...
                        .filter(obj =>
                            filterType === "" ? true : obj.category === filterType
                        )
                        .filter(obj =>
                            filterPrice === "" ? true : obj.price == filterPrice
                        )
                    ...
                    return (
                    <div onClick={() => window.location.href = `/Ecommerce/productinfo/${item.id}`} className="p-4 md:w-1/4  drop-shadow-lg " >
