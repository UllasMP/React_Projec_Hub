...
function Cart() {
  ...
  return (
    <Layout >
     <div className="min-h-screen bg-gray-100 pt-28 pb-24" style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '', }}>
        <h1 className="mb-10 text-center text-2xl font-bold">Cart Items</h1>
        <div className="mx-auto max-w-5xl px-4 sm:px-6 md:flex md:space-x-6 xl:px-0">
          <div className="rounded-lg md:w-2/3 ">

            <div className="mb-6 rounded-lg border drop-shadow-xl bg-white p-4 sm:p-6 sm:flex sm:justify-start" style={{ backgroundColor: mode === 'dark' ? 'rgb(32 33 34)' : '', color: mode === 'dark' ? 'white' : '', }}>
              <img src="https://dummyimage.com/400x400" alt="product-image" className="w-full max-h-48 object-cover rounded-lg sm:w-40 sm:max-h-full" />
